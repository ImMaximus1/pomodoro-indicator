...
class PreferencesDialog(Gtk.Dialog):
    def __init__(self):
        ...
        frame1.add(table1)
        #
        label0 = Gtk.Label(_('Number of pomodoros in set')+':')
        ...
        #
        label1 = Gtk.Label(_('Session length (minutes)')+':')
        ...
        label2 = Gtk.Label(_('Break length (minutes)')+':')
        ...
        label_long_break = Gtk.Label(_('Long break length (minutes)')+':')
        ...
        table1.attach(self.comboboxsound6, 1, 2, 6, 7,
                      ...
                      xpadding=5,
                      ypadding=5)
        # Add combobox for long break sound
        label6L = Gtk.Label(_('Sound on long break start') + ':')
        label6L.set_alignment(0, 0.5)
        table1.attach(label6L, 0, 1, 7, 8, xpadding=5, ypadding=5)
        self.comboboxsound6L = Gtk.ComboBox.new()
        self.comboboxsound6L.set_model(sounds)
        cell1 = Gtk.CellRendererText()
        self.comboboxsound6L.pack_start(cell1, True)
        self.comboboxsound6L.add_attribute(cell1, 'text', 0)
        table1.attach(self.comboboxsound6L, 1, 2, 7, 8,
                      xoptions=Gtk.AttachOptions.FILL,
                      yoptions=Gtk.AttachOptions.FILL,
                      xpadding=5,
                      ypadding=5)
        ...
        table1.attach(label7, 0, 1, 8, 9, xpadding=5, ypadding=5)
        self.switch7 = Gtk.Switch()
        table1.attach(self.switch7, 1, 2, 8, 9, xpadding=5, ypadding=5,
                      xoptions=Gtk.AttachOptions.SHRINK)
        label8 = Gtk.Label(_('Icons are dark')+':')
        label8.set_alignment(0, 0.5)
        table1.attach(label8, 0, 1, 9, 10, xpadding=5, ypadding=5)
        self.switch8 = Gtk.Switch()
        table1.attach(self.switch8, 1, 2, 9, 10, xpadding=5, ypadding=5,
                      xoptions=Gtk.AttachOptions.SHRINK)
        #
    ...
    def load_preferences(self):
        ...
        # Add load preferences for long break sound
        select_value_in_combo(self.comboboxsound6L,
                              configuration.get('long_break_sound_file'))
        self.switch7.set_active(os.path.exists(comun.FILE_AUTO_START))
        self.switch8.set_active(configuration.get('theme') == 'dark')
    ...
    def save_preferences(self):
        ...
        # Add save preferences for long break sound
        configuration.set('long_break_sound_file',
                          get_selected_value_in_combo(self.comboboxsound6L))
        ...
        if self.switch8.get_active():
            ...
            configuration.set('break_theme', 'light')
        else:
            configuration.set('theme', 'light')
            # Set type of break's icons like an inversion of selected team
            configuration.set('break_theme', 'dark')
        configuration.save()
